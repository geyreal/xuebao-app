<template>
  <view class="page">
    <view class="form-card">
      <text class="form-title">上传学习资源</text>
      <view class="input-group"><text class="label">资源标题</text><input v-model="form.title" class="input" placeholder="请输入资源标题" /></view>
      <view class="input-group"><text class="label">资源描述</text><textarea v-model="form.description" class="textarea" placeholder="请输入资源描述" /></view>
